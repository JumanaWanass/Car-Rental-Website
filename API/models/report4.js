...
class Report {
    ...
    static getRep4(custID) {
        ...
        SELECT 
            ...
            customer.Bdate AS customerBirthdate,
            customer.Street AS customerStreet,
            customer.CountryName AS customerCountry,
        ...
        FROM 
            reservation 
        JOIN 
            customer ON reservation.custID = customer.custID 
        JOIN 
            car ON reservation.carID = car.carID 
        WHERE 
